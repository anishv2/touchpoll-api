...
const question_set=new Schema({
    ...
    'endDate':{type:SchemaTypes.Date, required:true, default:Date.now()+(24*60*60*1000)}
});
...
const pollSchema=new Schema({
    ...
    'created_date':{type:SchemaTypes.Date, default:new Date(), required:true},
    'expiry_date':{type:SchemaTypes.Date, default:new Date(new Date().getTime() + (24 * 60 * 60 * 1000)), required:true},
